...
public class PageRankKushal {
  ...
  public static void main(String[] args) {
    ...
    String folder="web04";
    //String file="go.md";
    PCollection<KV<String,String>> pCollectionList1 = KushalMapper1(p,"go.md",folder);
   PCollection<KV<String,String>> pCollectionList2 = KushalMapper1(p,"python.md",folder);
   PCollection<KV<String,String>> pCollectionList3 = KushalMapper1(p,"java.md",folder);
   PCollection<KV<String,String>> pCollectionList4 = KushalMapper1(p,"README.md",folder);

   
    PCollectionList<KV<String, String>> pCollectionList = PCollectionList.of(pCollectionList1).and(pCollectionList2).and(pCollectionList3).and(pCollectionList4);
    ...
    pColLinkString.apply(TextIO.write().to("Kushalout"));  
    ...
    //KushalMapper1(p);
        ...
        //pcolLinks.apply(TextIO.write().to("Kushalout"));
  ...
  private static PCollection<KV<String, String>> KushalMapper1(Pipeline p,String dataFile ,String dataFolder ) {
    ...
    PCollection<String> pcolInputLines=p.apply(TextIO.read().from(dataPath));
      ...
      // PCollection<String> pcolKVstring =  pColKeyValuePairs.apply(
      ...
      //           kvinput -> kvinput.toString()));
      // pcolKVstring.apply(TextIO.write().to("kushalout"));
